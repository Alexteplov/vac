...
class VaccinationsControllerTest < ActionController::TestCase
  ...
  test "should create vaccination" do
    assert_difference('Vaccination.count') do
      post :create, vaccination: { fact: @vaccination.fact, person_id: @vaccination.person_id, plan: @vaccination.plan, vaccine_id: @vaccination.vaccine_id }
    end
  ...
  test "should update vaccination" do
    put :update, id: @vaccination, vaccination: { fact: @vaccination.fact, person_id: @vaccination.person_id, plan: @vaccination.plan, vaccine_id: @vaccination.vaccine_id }
    assert_redirected_to vaccination_path(assigns(:vaccination))
  end
